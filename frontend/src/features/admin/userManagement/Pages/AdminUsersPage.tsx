...
import { getAdminUsers, deleteUser, updateUserStatus } from '@/services/api/adminService';
...
const AdminUsersPage: React.FC = () => {
  ...
  const handleToggleStatus = async (userId: string) => {
    ...
    try {
      await updateUserStatus(parseInt(userId), newStatus === 'active');
      setUsers(
        users.map((u) =>
          u.id === userId
            ? { ...u, status: newStatus }
  ...
  const handleViewUser = (userId: string) => {
    // TODO: Navigate to user detail page or show modal
